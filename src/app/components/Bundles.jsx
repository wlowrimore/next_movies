...
const Bundles = () => {
  return (
    <div id='bundles' className='w-screen h-screen flex flex-col justify-center container'>
      ...
      <div className='flex gap-10 justify-center items-center'>
        <div className='flex flex-col py-8 px-6 rounded-2xl cursor-pointer border-2 border-amber-500 bg-blue-300 hover:border-2 hover:border-zinc-200 hover:bg-amber-400 active:scale-95 transition duration-300'>
        ...
        <div className='flex flex-col p-6 rounded-2xl cursor-pointer border-2 border-amber-500 bg-amber-200 hover:border-2 hover:border-amber-400 hover:bg-blue-300 active:scale-95 transition duration-300'>
        ...
        <div className='flex flex-col p-6 rounded-2xl cursor-pointer border-2 border-amber-500 bg-blue-300 hover:border-2 hover:border-zinc-200 hover:bg-amber-400 active:scale-95 transition duration-300'>
